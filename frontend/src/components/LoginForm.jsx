...
const LoginForm = () => {
    ...
    return (
        <div className="fixed top-0 bottom-0 left-0 right-0 z-30 flex items-center text-sm
        text-gray-600 bg-black/5"
            ...
            <form onClick={(e) => e.stopPropagation()}
                ...
                <p className="text-2xl font-medium m-auto ">
                    <span className="text-greem-500 text-green-500 ">User</span> {state === "login" ? "Login" : "Sign Up"}
                </p>
                {state === "register" && (
